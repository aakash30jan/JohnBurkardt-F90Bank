...
!*****************************************************************************80
!
!! MAIN is the main program for CG_SERIAL.
!
      implicit none
...
!*****************************************************************************80
!
!! CONJ_GRAD carries out the conjugate gradient method.
!
...
!*****************************************************************************80
!
!! MAKEA generates the system matrix A with specified sparsity.
!
      include             'npbparams.h'
...
!*****************************************************************************80
!
!! SPARSE generates a sparse matrix from a list of row, column, value triples.
!
...
!*****************************************************************************80
!
!! SPRNVC generates a vector having a given number of nonzero entries.
!
      implicit           none
      double precision   v(*)
      integer            n, nz, nn1, iv(*)
...
!*****************************************************************************80
!
!! ICNVRT multiplies a real number in (0,1) by a power of 2 and then floors it.
!
      implicit           logical (a-z)
      double precision   x
...
!*****************************************************************************80
!
!! VECSET sets the I-th entry of a sparse vector.
!
      implicit           logical (a-z)
