...
!
  ...
  write ( *, '(a)' ) '           = 0 elsewhere.'
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '  We use the Lax-Wendroff method:'
...
!
  ...
  do i = 1, nt
    ...
    do j = 1, nx
      ...
      unew(j) = u(j) - c1 * ( u(jp1) - u(jm1) ) + c2 * ( u(jp1) &
        - 2.0D+00 * u(j) + u(jm1) )
    end do
...
!
  ...
  write ( command_unit, '(a)' ) 'set output "advection_lax_wendroff.png"'
