...
!*****************************************************************************80
!
!! ADI carries out one step of the alternating direction implicit method.
!
      call compute_rhs ( )
...
!*****************************************************************************80
!
!! RHS_NORM computes the norm of the right hand side.
!
      include 'header.h'
...
!*****************************************************************************80
!
!! EXACT_RHS computes the right hand side based on the exact solution.
!
      include 'header.h'
...
!  Discussion:
!
!    The routine uses tri-linear transfinite interpolation of the 
!    boundary values.
!
      include 'header.h'
...
!*****************************************************************************80
!
!! LHSINIT initializes items on the left hand side of the equations.
!
      implicit none
      integer size
...
!*****************************************************************************80
!
!! COMPUTE_RHS computes the right hand side.
!
      include 'header.h'
...
!*****************************************************************************80
!
!! SET_CONSTANTS sets problem constants.
!
      include 'header.h'
...
!*****************************************************************************80
!
!! MATVEC_SUB computes bvec := bvec - ablock * avec
!
      implicit none
...
!*****************************************************************************80
!
!! TIMER_CLEAR clears timer information.
!
      implicit none
      integer n
...
!*****************************************************************************80
!
!! ELAPSED_TIME returns current wall clock time.
!
      implicit none
...
!     and then performs back substitution to solve for the unknown
