...
subroutine r8sp_diagonal ( m, n, nz_num, row, col, a )
...
subroutine r8sp_jac_sl ( n, nz_num, row, col, a, b, x, it_max )
...
!
  call r8sp_diagonal ( n, n, nz_num, row, col, a )
!
!  Carry out iteration.
!
  do it_num = 1, it_max
...
subroutine r8sp_mtv ( m, n, nz_num, row, col, a, x, b )

!*****************************************************************************80
!
!! R8SP_MTV multiplies an R8VEC times an R8SP matrix.
!
!  Discussion:
!
!    The R8SP storage format stores the row, column and value of each nonzero
...
subroutine r8sp_zeros ( m, n, nz_num, row, col, a )

!*****************************************************************************80
!
!! R8SP_ZEROS zeros out an R8SP matrix.
!
!  Discussion:
!
!    The R8SP storage format stores the row, column and value of each nonzero
