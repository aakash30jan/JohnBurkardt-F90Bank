...
!
  ...
  if ( r(1) == minval ( r(1:3) ) ) then
    ...
    ni = n
    nj = i4_ceiling ( r(2) / r(1) ) * real ( n, kind = 8 )
    nk = i4_ceiling ( r(3) / r(1) ) * real ( n, kind = 8 )
  else if ( r(2) == minval ( r(1:3) ) ) then
    h = 2.0D+00 * r(2) / real ( 2 * n + 1, kind = 8 )
    nj = n
    ni = i4_ceiling ( r(1) / r(2) ) * real ( n, kind = 8 )
    nk = i4_ceiling ( r(3) / r(2) ) * real ( n, kind = 8 )
  else
    h = 2.0D+00 * r(3) / real ( 2 * n + 1, kind = 8 )
    nk = n
    ni = i4_ceiling ( r(1) / r(3) ) * real ( n, kind = 8 )
    nj = i4_ceiling ( r(2) / r(3) ) * real ( n, kind = 8 )
  end if
