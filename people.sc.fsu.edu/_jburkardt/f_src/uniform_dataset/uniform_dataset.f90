...
!  Discussion:
!
!    UNIFORM_DATASET generates a uniform random dataset and writes it 
!    to a file.
!
!  Usage:
!
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'UNIFORM_DATASET'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Generate a uniform random dataset.'
  write ( *, '(a)' ) ' '
...
!
  write ( output_filename, '(a,i2.2,a,i5.5,a)' ) 'uniform_', m, '_', n, '.txt'
