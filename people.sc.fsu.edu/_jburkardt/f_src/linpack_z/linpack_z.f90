...
!
!    Input, integer ( kind = 4 ) LDR, the leading dimension of R, which is 
!    at least P.
!
!    Input, integer ( kind = 4 ) P, the order of the matrix.
!
...
!
!    Input, integer ( kind = 4 ) MU, the number of diagonals above the main 
!    diagonal.  0 <= MU < N.
...
!
!    Input, integer ( kind = 4 ) MU, the number of diagonals above the main
!    diagonal.  0 <= MU < N.  More efficient if ML <= MU.
!
!    Output, integer ( kind = 4 ) IPVT(N), the pivot indices.
!
!    Output, integer ( kind = 4 ) INFO.
