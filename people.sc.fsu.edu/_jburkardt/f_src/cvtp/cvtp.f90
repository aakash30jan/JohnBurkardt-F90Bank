...
!
    call cvtp_region_sampler ( m, 1, sample_num_cvt, x, &
      reset, seed, width )
...
subroutine cvtp_region_sampler ( m, n, n_total, x, reset, seed, width )
...
!
!    Input, integer ( kind = 4 ) N_TOTAL, the total number of points to
!    generate.
!
