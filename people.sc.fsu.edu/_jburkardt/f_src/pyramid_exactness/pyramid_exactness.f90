...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'PYRAMID_EXACTNESS'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Investigate the polynomial exactness of'
  write ( *, '(a)' ) '  a quadrature rule for the pyramid.'
!
...
!
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'PYRAMID_EXACTNESS: User input:'
  write ( *, '(a)' ) &
...
!
  ...
  if ( dim_num /= 3 ) then
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'PYRAMID_EXACTNESS - Fatal error!'
...
!
  ...
  do degree = 0, degree_max
    ...
    do
      ...
      call pyra_unit_monomial ( expon, exact )
