...
!
  ...
  write ( *, '(a)' ) '  * ORDER, the number of points:'
  write ( *, '(a)' ) '  * A, the left endpoint:'
  write ( *, '(a)' ) '  * B, the right endpoint:'
  write ( *, '(a)' ) '  * FILENAME, used to generate 3 filenames:'
...
!
  if ( 1 <= arg_num ) then
    ...
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) '  Enter the ORDER of the rule (number of points):'
    read ( *, * ) order
  end if
!
!  Get A.
