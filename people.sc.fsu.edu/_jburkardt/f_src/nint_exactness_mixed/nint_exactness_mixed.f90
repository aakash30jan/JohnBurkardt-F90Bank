...
!
  ...
  write ( *, '(a)' ) '  Quadrature rule A file = "' &
    // trim ( quad_a_filename ) // '".'
  write ( *, '(a)' ) '  Quadrature rule B file = "' &
    // trim ( quad_b_filename ) // '".'
...
!*****************************************************************************80
!
!! MONOMIAL_INTEGRAL_GENERALIZED_HERMITE: 1D monomial gen-Hermite integral.
!
!  Discussion:
!
...
!*****************************************************************************80
!
!! MONOMIAL_INTEGRAL_GENERALIZED_LAGUERRE: 1D monomial gen-Laguerre integral.
!
!  Discussion:
!
!    The integral being computed is
...
!*****************************************************************************80
!
!! MONOMIAL_INTEGRAL_JACOBI: integral of a monomial with Jacobi weight.
!
!  Discussion:
!
...
!
!    Output, real ( kind = 8 ) MONOMIAL_INTEGRAL_JACOBI, 
!    the value of the integral.
!
  implicit none
...
!    may be needed for Jacobi, Generalized-Laguerre, or 
!    Generalized Hermite rules.
!
...
!
!    Output, real ( kind = 8 ) R8_FACTORIAL2, the value of the 
