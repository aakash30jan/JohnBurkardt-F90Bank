...
subroutine i4_to_triangle_test ( )
...
!
  ...
  write ( *, '(a)' ) '  I4VEC_ASCENDS determines if an I4VEC ascends.'
  write ( *, '(a)' ) ' '
...
!
  ...
  write ( *, '(a)' ) '  I4VEC_DESCENDS determines if an I4VEC descends.'
...
!
  ...
  write ( *, '(a)' ) '  I4VEC_PAIRWISE_PRIME determines if an I4VEC'
...
subroutine triangle_to_i4_test ( )
