...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) &
    '   Then the user must define 1D quadrature rules to be used.'
  write ( *, '(a)' ) &
    '   Each rule is used for at least the "next" dimension, but can be'
  write ( *, '(a)' ) &
    '   used for several or all the remaining consecutive dimensions.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  Rule definition requires:'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  * Rule identifier:'
  write ( *, '(a)' ) &
    '    CC, F2, GP, GL, GH, GGH, LG, GLG, GJ, GW, CCS, F2S, GPS.'
  write ( *, '(a)' ) &
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) &
    '    * Files that define the alphas, betas, ranges, weights, abscissas.'
!
...
!
  ...
  do while ( dim_index < dim_num )
    ...
    write ( *, '(a)' ) &
      '  CC, F2, GP, GL, GH, GGH, LG, GLG, GJ, GW, CCS, F2S, GPS'
    write ( *, '(a,i8)' ) &
      '  Enter the rule identifier for dimension ', dim_index + 1
    read ( *, * ) rule_string
