...
!  Discussion:
!
!    This program investigates a standard Gauss-Chebyshev type 2 quadrature 
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'INT_EXACTNESS_CHEBYSHEV2'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) &
    '  Investigate the polynomial exactness of a Gauss-Chebyshev'
  write ( *, '(a)' ) '  type 2 quadrature rule by integrating weighted '
  write ( *, '(a)' ) &
...
!
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'INT_EXACTNESS_CHEBYSHEV2: User input:'
...
!
  ...
  if ( dim_num /= 1 ) then
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'INT_EXACTNESS_CHEBYSHEV2 - Fatal error!'
...
!
  ...
  write ( *, '(a)'       ) '  a Gauss-Chebyshev type 2 rule'
...
!
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  A Gauss-Chebyshev type 2 rule would be able to exactly'
  write ( *, '(a,i8)' ) &
  ...
  do degree = 0, degree_max
    ...
    call monomial_quadrature_chebyshev2 ( expon, order, w, x, quad_error )
...
subroutine monomial_quadrature_chebyshev2 ( expon, order, w, x, quad_error )

!*****************************************************************************80
!
!! MONOMIAL_QUADRATURE_CHEBYSHEV2 approximates Cheby type 2 monomial integral.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!  Get the exact value of the integral.
!
  call chebyshev2_integral ( expon, exact )
!
