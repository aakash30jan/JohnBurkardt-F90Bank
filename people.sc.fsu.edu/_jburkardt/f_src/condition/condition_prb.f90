...
!
  ...
  call condition_linpack_test ( )
  call condition_sample1_test ( )
  call condition_hager_test ( )
!
!  Terminate.
!
  write ( *, '(a)' ) ' '
...
subroutine condition_linpack_test ( )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'CONDITION_LINPACK_TEST'
  write ( *, '(a)' ) '  CONDITION_LINPACK estimates the L1 condition number'
  write ( *, '(a)' ) '  of a matrix in general storage mode.'
  write ( *, '(a)' ) ' '
...
subroutine condition_sample1_test ( )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'CONDITION_SAMPLE1_TEST'
...
subroutine condition_hager_test ( )
