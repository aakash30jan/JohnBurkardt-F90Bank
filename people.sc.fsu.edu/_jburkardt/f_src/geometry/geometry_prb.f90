...
!
  ...
  call polygon_contains_point_2d_test ( )
  call polygon_contains_point_2d_2_test ( )
  call polygon_contains_point_2d_3_test ( )
  call polygon_diameter_2d_test ( )
...
!*****************************************************************************80
!
!! TEST026 tests ELLIPSE_POINTS_2D;
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
subroutine polygon_contains_point_2d_test ( )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'POLYGON_CONTAINS_POINT_2D_TEST'
  ...
  do test = 1, test_num
    ...
    call polygon_contains_point_2d ( n, v, p, inside )

    write ( *, '(2x,2g14.6,4x,l1)' ) p(1:dim_num), inside

  end do
 
  return
end
subroutine polygon_contains_point_2d_2_test ( )

!*****************************************************************************80
!
!! POLYGON_CONTAINS_POINT_2D_2_TEST tests POLYGON_CONTAINS_POINT_2D_2.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'POLYGON_CONTAINS_POINT_2D_2_TEST'
  ...
  do test = 1, test_num
    ...
    call polygon_contains_point_2d_2 ( n, v, p, inside )
...
subroutine polygon_contains_point_2d_3_test ( )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'POLYGON_CONTAINS_POINT_2D_3_TEST'
  write ( *, '(a)' ) '  POLYGON_CONTAINS_POINT_2D_3 determines if '
  write ( *, '(a)' ) '  a point is in a polygon.'
  ...
  do test = 1, test_num
    ...
    call polygon_contains_point_2d_3 ( n, v, p, inside )
...
subroutine polygon_diameter_2d_test ( )

!*****************************************************************************80
!
!! POLYGON_DIAMETER_2D_TEST tests POLYGON_DIAMETER_2D;
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'POLYGON_DIAMETER_2D_TEST'
  write ( *, '(a)' ) '  POLYGON_DIAMETER_2D computes the diameter of a polygon.'
