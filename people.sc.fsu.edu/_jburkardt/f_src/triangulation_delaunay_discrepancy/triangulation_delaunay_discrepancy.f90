...
!
  ...
  write ( *, '(a)' ) '  by which the minimum angle in the triangulation could'
  write ( *, '(a)' ) &
    '  be changed by a single adjustment of a pair of triangles.'
  write ( *, '(a)' ) ' '
...
!
      ...
      if ( n4 == -1 ) then
        ...
        write ( *, '(a,3i8)' ) &
          '  Neighbors = ', triangle_neighbor(1:3,triangle1)
        write ( *, '(a)' ) ' '
        ...
        write ( *, '(a,3i8)' ) &
          '  Neighbors = ', triangle_neighbor(1:3,triangle2)
        stop
      end if
!
