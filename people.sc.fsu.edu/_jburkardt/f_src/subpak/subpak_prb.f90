...
!
  ...
  call angle_shift_test ( )
  call angle_shift_deg_test ( )
  call test03 ( )
  call test04 ( )
  call test05 ( )
  call test06 ( )
...
subroutine angle_shift_test ( )

!*****************************************************************************80
!
!! ANGLE_SHIFT_TEST tests ANGLE_SHIFT.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
subroutine angle_shift_deg_test ( )

!*****************************************************************************80
!
!! ANGLE_SHIFT_DEG_TEST tests ANGLE_SHIFT_DEG.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
