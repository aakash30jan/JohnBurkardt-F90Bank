...
!  Parameters:
!
!    Input, real ( kind = 8 ) U(N+1), the polynomial coefficients.
!    U(1) is ignored.
!
!    Input, real ( kind = 8 ) H, the polynomial argument.
!
!    Input, integer ( kind = 4 ) N, the number of terms to compute.
!
!    Output, real ( kind = 8 ) TS_MULT, the value of the polynomial.
!
  implicit none
