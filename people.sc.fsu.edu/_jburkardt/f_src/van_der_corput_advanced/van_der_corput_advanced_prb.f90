...
!*****************************************************************************80
!
!! MAIN is the main program for VAN_DER_CORPUT_ADVANCED_PRB.
!
!  Discussion:
!
!    VAN_DER_CORPUT_ADVANCED_PRB tests the VAN_DER_CORPUT_ADVANCED library.
!
!  Licensing:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'VAN_DER_CORPUT_ADVANCED_PRB'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the VAN_DER_CORPUT_ADVANCED library.'
