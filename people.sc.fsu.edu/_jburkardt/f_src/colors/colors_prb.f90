...
!  Discussion:
!
!    COLORS_PRB tests the COLORS library.
!
!  Licensing:
!
...
!
  ...
  write ( *, '(a)' ) '  Test the COLORS library.'
...
!
  ...
  integer ( kind = 4 ), parameter :: ntest = 17
...
!
  ...
  integer ( kind = 4 ), parameter :: nm_step = 81
  integer ( kind = 4 ), parameter :: purple_step = 21
  real ( kind = 8 ) u
  real ( kind = 8 ) v
  real ( kind = 8 ) xcap
  real ( kind = 8 ) xcapn
