...
!  Discussion:
!
!    SGMGA_UNIQUE_INDEX_PRB tests the SGMGA library.
!
!  Licensing:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'SGMGA_UNIQUE_INDEX_PRB:'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the SGMA_UNIQUE_INDEX function.'

  call sgmga_unique_index_tests ( )

  call sgmga_unique_index_negative_tolerance_tests ( )

  call sgmga_unique_index_zero_tolerance_tests ( )
!
!  Terminate.
!
  write ( *, '(a)' ) ' '
...
subroutine sgmga_unique_index_negative_tolerance_tests ( )

!****************************************************************************80
!
!! SGMGA_UNIQUE_INDEX_NEGATIVE_TOLERANCE_TESTS uses a negative tolerance.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'SGMGA_UNIQUE_INDEX_NEGATIVE_TOLERANCE_TESTS'
  write ( *, '(a)' ) '  Call SGMGA_UNIQUE_INDEX_TEST with various arguments'
!
...
!
  ...
  allocate ( p(1:np_sum) )
  call sgmga_unique_index_test ( dim_num, importance, level_weight, &
...
subroutine sgmga_unique_index_zero_tolerance_tests ( )

!****************************************************************************80
!
!! SGMGA_UNIQUE_INDEX_ZERO_TOLERANCE_TESTS uses a zero tolerance.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'SGMGA_UNIQUE_INDEX_ZERO_TOLERANCE_TESTS'
  write ( *, '(a)' ) '  Call SGMGA_UNIQUE_INDEX_TEST with various arguments'
!
!  Set the point equality tolerance.
!
...
subroutine sgmga_unique_index_tests ( )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'SGMGA_UNIQUE_INDEX_TESTS'
  write ( *, '(a)' ) '  Call SGMGA_UNIQUE_INDEX_TEST with various arguments'
!
!  Set the point equality tolerance.
!
...
subroutine sgmga_unique_index_test ( dim_num, importance, level_weight, &
  level_max_min, level_max_max, rule, growth, np, p, tol )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'SGMGA_UNIQUE_INDEX_TEST'
  write ( *, '(a)' ) '  SGMGA_UNIQUE_INDEX returns a mapping between'
  write ( *, '(a)' ) '  the nonunique and unique points in a sparse grid.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  IMPORTANCE:'
  ...
  do level_max = level_max_min, level_max_max
    ...
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) ' LEVEL_MAX POINT_NUM POINT_NUM'
    ...
    call sgmga_unique_index ( dim_num, level_weight, level_max, rule, growth, &
      np, p, tol, point_num, point_total_num, sparse_unique_index )

    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) '     POINT    UNIQUE'
    write ( *, '(a)' ) ' '
    do point = 1, point_total_num
      write ( *, '(2x,i8,2x,i8)' ) point, sparse_unique_index(point)
    end do
