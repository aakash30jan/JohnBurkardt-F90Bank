...
!  Discussion:
!
!    SGMGA_INDEX_PRB tests the SGMGA library.
!
!  Licensing:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'SGMGA_INDEX_PRB:'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the SGMGA_INDEX function.'

  call sgmga_index_tests ( )
!
!  Terminate.
!
  write ( *, '(a)' ) ' '
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'SGMGA_INDEX_TESTS'
  write ( *, '(a)' ) '  Call SGMGA_INDEX_TEST with various arguments.'
!
...
!
  ...
  allocate ( p(1:np_sum) )
  call sgmga_index_test ( dim_num, importance, level_weight, level_max_min, &
...
subroutine sgmga_index_test ( dim_num, importance, level_weight, &
...
!
!    Input, integer ( kind = 4 ) NP(DIM_NUM), the number of parameters used
!    by each rule.
!
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'SGMGA_INDEX_TEST'
  write ( *, '(a)' ) '  SGMGA_INDEX returns index and order vectors that'
