...
!
!    Input/output, integer ( kind = 4 ) Z(M), the cluster to which each data
!    item is assigned.
!
!    Output, integer ( kind = 4 ) MJ(N), the number of data items in 
!    each cluster.
!
!    Input, integer ( kind = 4 ) N, the number of clusters.
!
!    Output, integer ( kind = 4 ) E(N), the per-cluster value of the
!    L1 criterion.
!
...
!    Input, integer ( kind = 4 ) N, the number of clusters.
!
!    Input/output, integer ( kind = 4 ) Z(M), the cluster to which each 
...
!
!    Output, integer ( kind = 4 ) NNMAX, the number of values of RJ that 
!    were set.
!
!    Output, integer ( kind = 4 ) KMAX, the number of times the loop was 
!    executed, and the number of values of TJ and FJ that were set.
!
  implicit none
...
!
!    Input, integer ( kind = 4 ) M0, the minimum number of items in 
!    each cluster.
!
!    Input, integer ( kind = 4 ) N, the number of clusters.
!
