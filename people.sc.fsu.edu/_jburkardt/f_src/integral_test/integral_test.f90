...
!
!    Input, integer ( kind = 4 ) INTEGRAL_NUM, the number of integrals 
!    to approximate.
!
!    Input, integer ( kind = 4 ) INTEGRAL_INDEX(INTEGRAL_NUM), the indices of 
!    the integrals to approximate.
!
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) &
    '  Problem    Region        Correct       Estimated' // &
    '      Absolute      Relative'
  write ( *, '(a)' ) &
    '  Index      Volume        Integral      Integral' // &
    '       Error         Error (%)'
  write ( *, '(a)' ) ' '
...
!    to approximate.
!
!    Input, integer ( kind = 4 ) INTEGRAL_INDEX(INTEGRAL_NUM), the indices 
!    of the integrals to approximate.
!
!    Input, real ( kind = 8 ) WEIGHT(NPOINT), the weights.
!
!    Output, real ( kind = 8 ) INTEGRAL_REL_ERROR(INTEGRAL_NUM), the 
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '             Average       Maximum       ' // &
    'Average       Maximum'
  write ( *, '(a)' ) '  Integral   Absolute      Absolute      ' // &
    'Relative      Relative'
  write ( *, '(a)' ) '             Error         Error         ' // &
    'Error %       Error %'
  write ( *, '(a)' ) ' '
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) &
    '  Problem    Region        Correct       ' // &
    'Estimated      Absolute      Relative'
  write ( *, '(a)' ) &
    '  Index      Volume        Integral      ' // &
