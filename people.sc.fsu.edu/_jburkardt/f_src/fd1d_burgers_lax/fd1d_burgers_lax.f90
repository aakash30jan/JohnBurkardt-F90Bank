...
!
  ...
  call report ( step, step_num, n, x, t, un, stability )
!
...
subroutine report ( step, step_num, n, x, t, u, stability )
...
!
!    Input, real ( kind = 8 ) STABILITY, the stability factor, which should be 
!    no greater than 1.
!
  implicit none
