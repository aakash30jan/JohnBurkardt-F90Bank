...
!
!    Thanks to Leon Yang for suggesting code to read MU and A from the
!    commandline, 09 May 2016.
!
!  Usage:
!
...
!
!  Get the variance-covariance matrix A(1:M,1:M).
!
  allocate ( a(1:m,1:m) )
