...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'HALTON_DATASET'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Generate a Halton dataset.'
  write ( *, '(a)' ) ' '
  ...
  write ( *, '(a)' ) '  * SEED(1:DIM_NUM), the Halton sequence element'
  write ( *, '(a)' ) '    corresponding to STEP = 0'
  write ( *, '(a)' ) '  * LEAP(1:DIM_NUM), the successive jumps in the '
  write ( *, '(a)' ) '    Halton sequence.'
  write ( *, '(a)' ) '  * BASE(1:DIM_NUM), the Halton bases,'
  write ( *, '(a)' ) '    usually distinct primes.'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  The program generates the data, writes it to the file'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '    halton_DIM_NUM_N.txt'
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  where "DIM_NUM" and "N" are numeric values specified'
  ...
  do
    ...
    if ( ios /= 0 ) then
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'HALTON_DATASET - Warning!'
    ...
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) '  Enter SEED(1:DIM_NUM), the Halton sequence index'
    write ( *, '(a)' ) '  corresponding to STEP = 0'
    write ( *, '(a)' ) &
    ...
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) '  Enter LEAP(1:DIM_NUM), the successive jumps in '
    write ( *, '(a)' ) '  the Halton sequence.'
    write ( *, '(a)' ) &
    ...
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) '  Enter BASE(1:DIM_NUM), the Halton bases,'
    write ( *, '(a)' ) '  usually distinct primes.'
    write ( *, '(a)' ) &
      '  (Try "2 3 5 7 11 13 ..." if you do not have a preference).'
    write ( *, '(a)' ) '  (any value 1 or less terminates execution.)'
