...
!*****************************************************************************80
!
!! MAIN is the main program for _PRB.
!
!  Discussion:
!
!    TETRAHEDRON_KEAST_RULE_PRB tests the TETRAHEDRON_KEAST_RULE library.
!
!  Licensing:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TETRAHEDRON_KEAST_RULE_PRB:'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the TETRAHEDRON_KEAST_RULE library.'
