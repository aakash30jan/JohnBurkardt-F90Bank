...
!*****************************************************************************80
!
!! MAIN is the main program for TETRAHEDRON_NCO_RULE_PRB.
!
!  Discussion:
!
!    TETRAHEDRON_NCO_RULE_PRB tests the TETRAHEDRON_NCO_RULE library.
!
!  Licensing:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TETRAHEDRON_NCO_RULE_PRB:'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the TETRAHEDRON_NCO_RULE library.'
...
!*****************************************************************************80
!
!! TEST01 tests TETRAHEDRON_NCO_RULE_NUM, *_DEGREE, *_ORDER_NUM.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST01'
  write ( *, '(a)' ) '  TETRAHEDRON_NCO_RULE_NUM returns the number of rules;'
  write ( *, '(a)' ) '  TETRAHEDRON_NCO_DEGREE returns the degree of a rule;'
  write ( *, '(a)' ) '  TETRAHEDRON_NCO_ORDER_NUM returns the order of a rule.'

  call tetrahedron_nco_rule_num ( rule_num )
  ...
  do rule = 1, rule_num
    call tetrahedron_nco_order_num ( rule, order_num )
    call tetrahedron_nco_degree ( rule, degree )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST02'
  write ( *, '(a)' ) '  TETRAHEDRON_NCO_RULE returns the points and weights'
  ...
  do rule = 1, rule_num
    ...
    call tetrahedron_nco_rule ( rule, order_num, xyztab, wtab )
...
!
  ...
  do rule = 1, rule_num
    ...
    call tetrahedron_nco_suborder_num ( rule, suborder_num )

    allocate ( suborder_w(1:suborder_num) )
    allocate ( suborder_xyz(1:4,1:suborder_num) )

    call tetrahedron_nco_subrule ( rule, suborder_num, suborder_xyz, suborder_w )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST04'
  write ( *, '(a)' ) '  TETRAHEDRON_NCO_RULE returns the points and weights of'
...
!
  ...
  call tetrahedron_nco_rule ( rule, order_num, xyz, w )
!
...
!
  ...
  call tetrahedron_nco_suborder ( rule, suborder_num, suborder )
...
!*****************************************************************************80
!
!! TEST07 tests TETRAHEDRON_NCO_RULE.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  do rule = 1, rule_num
    ...
    call tetrahedron_nco_subrule ( rule, suborder_num, suborder_xyz, &
      suborder_w )
