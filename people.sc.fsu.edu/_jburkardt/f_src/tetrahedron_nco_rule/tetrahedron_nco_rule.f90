...
subroutine tetrahedron_nco_degree ( rule, degree )

!*****************************************************************************80
!
!! TETRAHEDRON_NCO_DEGREE returns the degree of an NCO rule.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  if ( 1 <= rule .and. rule <= 7 ) then
    ...
    degree = -1
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'TETRAHEDRON_NCO_DEGREE - Fatal error!'
...
subroutine tetrahedron_nco_order_num ( rule, order_num )

!*****************************************************************************80
!
!! TETRAHEDRON_NCO_ORDER_NUM returns the order of an NCO rule.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
subroutine tetrahedron_nco_rule ( rule, order_num, xyz, w )
...
!
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'TETRAHEDRON_NCO_RULE - Fatal error!'
...
subroutine tetrahedron_nco_rule_num ( rule_num )
...
subroutine tetrahedron_nco_suborder ( rule, suborder_num, suborder )
...
!
  ...
  if ( rule == 1 ) then
    ...
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'TETRAHEDRON_NCO_SUBORDER - Fatal error!'
    write ( *, '(a,i8)' ) '  Illegal RULE = ', rule
    stop
...
subroutine tetrahedron_nco_suborder_num ( rule, suborder_num )
...
!
  ...
  if ( 1 <= rule .and. rule <= 7 ) then
    ...
    suborder_num = -1
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'TETRAHEDRON_NCO_SUBORDER_NUM - Fatal error!'
    write ( *, '(a,i8)' ) '  Illegal RULE = ', rule
    stop
...
subroutine tetrahedron_nco_subrule ( rule, suborder_num, suborder_xyz, &
  suborder_w )
...
!
  ...
  if ( rule == 1 ) then
    ...
    write ( *, '(a)' ) ' '
    write ( *, '(a)' ) 'TETRAHEDRON_NCO_SUBRULE - Fatal error!'
    write ( *, '(a,i8)' ) '  Illegal RULE = ', rule
    stop
