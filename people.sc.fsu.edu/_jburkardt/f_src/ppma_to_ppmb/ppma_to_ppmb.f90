...
!
!    Input, integer ( kind = 4 ) NCOL, NROW, the number of rows and 
!    columns of data.
!
  implicit none
...
!
!    Input, integer ( kind = 4 ) MAXP, the number of entries available in R, G 
!    and B.  If MAXP is smaller than NROW*NCOL, then the data will not be read.
!
