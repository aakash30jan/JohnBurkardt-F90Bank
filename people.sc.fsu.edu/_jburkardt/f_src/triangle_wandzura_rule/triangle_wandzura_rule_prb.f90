...
!*****************************************************************************80
!
!! MAIN is the main program for TRIANGLE_WANDZURA_RULE_PRB.
!
!  Discussion:
!
!    TRIANGLE_WANDZURA_RULE_PRB tests the TRIANGLE_WANDZURA_RULE library.
!
!  Licensing:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TRIANGLE_WANDZURA_RULE_PRB'
...
!
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TRIANGLE_WANDZURA_RULEA_PRB'
