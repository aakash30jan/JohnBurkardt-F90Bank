...
!*****************************************************************************80
!
!! OMP_GET_ANCESTOR_THREAD_NUM returns thread number of ancestor of this thread.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!*****************************************************************************80
!
!! OMP_GET_LEVEL returns number of nested parallel regions enclosing this task.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!*****************************************************************************80
!
!! OMP_GET_MAX_ACTIVE_LEVELS gets max number of nested active parallel regions.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!*****************************************************************************80
!
!! OMP_SET_MAX_ACTIVE_LEVELS limits number of nested active parallel regions.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
...
!  Parameters:
!
!    Input/output, integer ( kind = omp_nest_lock_kind ) NLOCK, the 
!    nestable lock.
!
  implicit none
...
!  Parameters:
!
!    Input/output, integer ( kind = omp_nest_lock_kind ) NLOCK, the nestable
!    lock.  If the lock was initialized but not set, it is set by this call.
!
