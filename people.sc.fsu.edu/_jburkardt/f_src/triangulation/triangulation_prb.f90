...
!
  ...
  integer ( kind = 4 ) adj(node_num,node_num)
  ...
  write ( *, '(a)' ) 'TEST127'
  write ( *, '(a)' ) '  For an order3 triangulation:'
  write ( *, '(a)' ) '  TRIANGULATION_ORDER3_ADJACENCY sets the full'
  write ( *, '(a)' ) '  adjacency matrix.'

  call triangulation_order3_adjacency ( node_num, element_num, element_node, &
    adj )
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) '               1         2         3         4        '
  write ( *, '(a)' ) '      123456789012345678901234567890123456789012345678'
  write ( *, '(a)' ) ' '
  do i = 1, node_num
    write ( *, '(2x,i2,2x,48i1)' ) i, adj(i,1:node_num)
  end do
