...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'CYCLE_BRENT_PRB'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the CYCLE_BRENT library.'
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST01'
  write ( *, '(a)' ) '  Test CYCLE_BRENT on F1().'
  write ( *, '(a)' ) '  f1(0) = 6.'
  write ( *, '(a)' ) '  f1(1) = 6.'
  write ( *, '(a)' ) '  f1(2) = 0.'
  write ( *, '(a)' ) '  f1(3) = 1.'
...
!  Parameters:
!
!    Input, integer ( kind = 4 ) I, the argument of the function.
!
!    Output, integer ( kind = 4 ) F1, the value of the function.
!
  implicit none
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST02'
  write ( *, '(a)' ) '  Test CYCLE_BRENT for F2().'
...
!    Input, integer ( kind = 4 ) I, the argument of the function.
!
!    Output, integer ( kind = 4 ) F2, the value of the function.
!
  implicit none
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST03'
  write ( *, '(a)' ) '  Test CYCLE_BRENT for F3().'
...
!    Input, integer ( kind = 4 ) I, the argument of the function.
!
!    Output, integer ( kind = 4 ) F3, the value of the function.
!
  implicit none
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST04'
  write ( *, '(a)' ) '  Test CYCLE_BRENT for F4().'
...
!    Input, integer ( kind = 4 ) I, the argument of the function.
!
!    Output, integer ( kind = 4 ) F4, the value of the function.
!
  implicit none
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST05'
  write ( *, '(a)' ) '  Test CYCLE_BRENT for F5().'
...
!    Input, integer ( kind = 4 ) I, the argument of the function.
!
!    Output, integer ( kind = 4 ) F5, the value of the function.
!
  implicit none
