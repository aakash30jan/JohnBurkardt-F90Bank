...
!
  ...
  call include_handle ( input_unit, output_unit, include_num, include_bad_num )
...
subroutine include_handle ( input_unit, output_unit, include_num, &
  include_bad_num )

!*****************************************************************************80
!
!! INCLUDE_HANDLE makes a copy of a FORTRAN file with INCLUDE files included.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
