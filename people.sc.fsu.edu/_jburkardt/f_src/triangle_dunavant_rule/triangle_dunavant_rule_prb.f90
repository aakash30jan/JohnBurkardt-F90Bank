...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TRIANGLE_DUNAVANT_RULE_PRB:'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the TRIANGLE_DUNAVANT_RULE library.'
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST01'
  write ( *, '(a)' ) '  DUNAVANT_RULE_NUM returns the number of rules;'
  write ( *, '(a)' ) '  DUNAVANT_DEGREE returns the degree of a rule;'
  write ( *, '(a)' ) '  DUNAVANT_ORDER_NUM returns the order of a rule.'

  call dunavant_rule_num ( rule_num )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST02'
  write ( *, '(a)' ) '  DUNAVANT_RULE returns the points and weights'
  write ( *, '(a)' ) '  of a Dunavant rule for the triangle.'
  write ( *, '(a)' ) ' '
  ...
  do rule = 1, rule_num
    ...
    call dunavant_rule ( rule, order_num, xytab, wtab )
...
!
  ...
  real ( kind = 8 ) coef
  integer ( kind = 4 ) rule
  integer ( kind = 4 ), parameter :: rule_max = 10
  real ( kind = 8 ) err
  real ( kind = 8 ) exact
  integer ( kind = 4 ) i
  integer ( kind = 4 ) order_num
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST04'
  write ( *, '(a)' ) '  DUNAVANT_RULE returns the points and weights of'
  write ( *, '(a)' ) '  a Dunavant rule for the unit triangle.'
  write ( *, '(a)' ) ' '
...
!
  ...
  call dunavant_rule ( rule, order_num, xy, w )
!
