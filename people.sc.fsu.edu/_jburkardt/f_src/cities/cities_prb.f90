...
!
  ...
  call test01 ( 'wg22' )
  call test02 ( 'usca312' )
  call dms_to_xy_test ( 'usca312' )
  call dist_table_check_test ( 'spaeth2_09' )
  call ll_degrees_to_xy_test ( 'uscap' )
!
!  Terminate.
!
  write ( *, '(a)' ) ' '
...
subroutine dms_to_xy_test ( prefix )

!*****************************************************************************80
!
!! DMS_TO_XY_TEST tests DMS_TO_XY.
!
!  Discussion:
!
!    Get the DMS coordinates of a set of cities, and compute
...
subroutine dist_table_check_test ( prefix )

!*****************************************************************************80
!
!! DIST_TABLE_CHECK_TEST tests DIST_TABLE_CHECK.
!
!  Discussion:
!
...
subroutine ll_degrees_to_xy_test ( prefix )

!*****************************************************************************80
!
!! LL_DEGREES_TO_XY_TEST tests LL_DEGREES_TO_XY.
!
!  Discussion:
!
