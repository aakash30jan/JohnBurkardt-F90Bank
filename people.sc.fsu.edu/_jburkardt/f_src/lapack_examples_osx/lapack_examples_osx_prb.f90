...
!*****************************************************************************80
!
!! MAIN is the main program for LAPACK_EXAMPLES_OSX_PRB.
!
!  Discussion:
!
!    LAPACK_EXAMPLES_OSX_PRB tests the OSX version of the LAPACK library.
!
!  Licensing:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'LAPACK_EXAMPLES_OSX_PRB'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the OSX version of the LAPACK library.'
