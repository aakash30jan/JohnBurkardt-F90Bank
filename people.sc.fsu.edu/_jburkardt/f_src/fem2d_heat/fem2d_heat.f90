...
!
!    Local, integer ( kind = 4 ) DIM_NUM, the spatial dimension, which is 2.
!
...
!
!    Local, integer ( kind = 4 ) ELEMENT_ORDER, the order of each element.
!
...
!
!    Local, integer ( kind = 4 ) NODE_CONDITION(NODE_NUM), indicates the type of
...
!
!    Neumann conditions will be OK if the specified flux value is zero.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
