...
!*****************************************************************************80
!
!! MAIN is the main program for GEGENBAUER_POLYNOMIAL_PRB.
!
!  Discussion:
!
!    GEGENBAUER_POLYNOMIAL_PRB tests the GEGENBAUER_POLYNOMIAL library.
!
!  Licensing:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'GEGENBAUER_POLYNOMIAL_PRB'
