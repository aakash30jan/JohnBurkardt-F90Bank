...
subroutine partition_brute_test ( n, w )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'PARTITION_BRUTE_TEST:'
  write ( *, '(a)' ) '  PARTITION_BRUTE partitions a set of N integers W so that the subsets'
...
subroutine partition_count_test ( n, w )
