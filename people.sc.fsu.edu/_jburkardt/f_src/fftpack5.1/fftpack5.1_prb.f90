...
!*****************************************************************************80
!
!! MAIN is the main program for FFTPACK5.1_PRB.
!
!  Discussion:
!
!    FFTPACK5.1_PRB tests the FFTPACK5.1 library.
!
!  Licensing:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'FFTPACK5.1_PRB'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the FFTPACK5.1 library.'
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST01'
  write ( *, '(a)' ) '  For complex single precision fast Fourier transforms, 1D,'
...
!
  ...
  call c4vec_print_part ( n, c, 10, '  The original data:' ) 
!
...
!
  ...
  call c4vec_print_part ( n, c, 10, '  The FFT coefficients:' )
!
...
!
  ...
  call c4vec_print_part ( n, c, 10, '  The retrieved data:' )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST02'
  write ( *, '(a)' ) '  For complex single precision fast Fourier transforms, 2D,'
...
!
  ...
  lensav = 2 * l + int ( log ( real ( l, kind = 4 ) ) / log ( 2.0E+00 ) ) &
    + 2 * m + int ( log ( real ( m, kind = 4 ) ) / log ( 2.0E+00 ) ) &
    + 8 
...
!
  ...
  call c4mat_print_some ( l, m, c, 1, 1, 5, 5, '  Part of the retrieved data:' )
...
!
  ...
  complex ( kind = 4 ), allocatable, dimension ( : ) :: c
  integer ( kind = 4 ) ier
  integer ( kind = 4 ) inc
  integer ( kind = 4 ) jump
  integer ( kind = 4 ) lenc
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST03'
  write ( *, '(a)' ) '  For complex single precision fast Fourier transforms, 1D, multiple'
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST04'
  write ( *, '(a)' ) '  For real single precision fast cosine transforms, 1D,'
...
!
  ...
  call r4vec_print_part ( n, r, 10, '  The original data:' )
!
!  Compute the FFT coefficients.
!
  inc = 1
  ...
  call r4vec_print_part ( n, r, 10, '  The FFT coefficients:' )
!
!  Compute inverse FFT of coefficients.  Should get back the
!  original data.
!
  ...
  call r4vec_print_part ( n, r, 10, '  The retrieved data:' )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST05'
  write ( *, '(a)' ) '  For real single precision fast cosine transform, 1D, multiple'
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST07'
  write ( *, '(a)' ) '  For real single precision fast cosine transforms, 1D, multiple'
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST10'
  write ( *, '(a)' ) '  For real single precision fast Fourier transform, 2D,'
...
!
  ...
  lensav = &
          l + int ( log ( real ( l, kind = 4 ) ) / log ( 2.0E+00 ) ) + 4 &
    + 2 * m + int ( log ( real ( m, kind = 4 ) ) / log ( 2.0E+00 ) ) + 4 &
    +     m + int ( log ( real ( m, kind = 4 ) ) / log ( 2.0E+00 ) ) + 4
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST11'
  write ( *, '(a)' ) '  For real single precision fast Fourier transform, 1D, multiple'
...
!
  ...
  call r4mat_print_some ( n, lot, r, 1, 1, 5, 5, '  Part of the original data:' )
!
!  Compute the FFT coefficients.
!
  jump = n
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST12'
  write ( *, '(a)' ) '  For real single precision fast sine transforms, 1D,'
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST13'
  write ( *, '(a)' ) '  For real single precision fast sine transforms, 1D, multiple'
