...
!
  ...
  write ( *, '(a)' ) '  NORMAL_01_SAMPLE samples the Normal 01 PDF;'
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'NORMAL_SAMPLE_TEST'
  write ( *, '(a)' ) '  NORMAL_MEAN computes the Normal mean;'
  write ( *, '(a)' ) '  NORMAL_SAMPLE samples the Normal distribution;'
