...
!*****************************************************************************80
!
!! MAIN is the main program for IEEE_UNIFORM_SAMPLE_PRB.
!
!  Discussion:
!
!    IEEE_UNIFORM_SAMPLE_PRB tests the IEEE_UNIFORM_SAMPLE library.
!
!  Licensing:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'IEEE_UNIFORM_SAMPLE_PRB'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the IEEE_UNIFORM_SAMPLE library.'
