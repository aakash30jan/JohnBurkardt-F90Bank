...
!    * comments begin with a lowercase "c";
!    * continuation characters are "&";
!    * trailing blank characters are trimmed;
!    * (noncomment) lines are no longer than 72 characters.
!
!  Usage:
!
...
!
  ...
  write ( *, '(a)' ) ' * trailing blank characters are trimmed;'
