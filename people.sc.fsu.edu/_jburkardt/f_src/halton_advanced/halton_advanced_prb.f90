...
!*****************************************************************************80
!
!! MAIN is the main program for HALTON_ADVANCED_PRB.
!
!  Discussion:
!
!    HALTON_ADVANCED_PRB tests the HALTON_ADVANCED library.
!
!  Licensing:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'HALTON_ADVANCED_PRB'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the HALTON_ADVANCED library.'
