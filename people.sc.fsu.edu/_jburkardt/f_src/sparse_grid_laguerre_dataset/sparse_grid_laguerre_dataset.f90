...
!*****************************************************************************80
!
!! LAGUERRE_ABSCISSA sets abscissas for Gauss-Laguerre quadrature.
!
!  Discussion:
!
...
!*****************************************************************************80
!
!! LAGUERRE_INTEGRAL_ND: evaluate multidimensional Laguerre polynomial integral.
!
!  Discussion:
!
!    L(1,n) = Integral ( 0 <= x < +oo ) x^n exp ( -x ) dx
!           = n!
!
!    L(d,n) = Integral ( 0 <= x(i) < +oo )
