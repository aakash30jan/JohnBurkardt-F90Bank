...
!
!    Output, integer ( kind = 4 ) IUNIT, the FORTRAN unit number to be used.
!
  implicit none
...
!  Parameters:
!
!    Input, integer ( kind = 4 ) IUNIT, the FORTRAN unit number.
!
  implicit none
...
!  Parameters:
!
!    Input, integer ( kind = 4 ) IUNIT, the FORTRAN unit.
!
...
!    Input, integer ( kind = 4 ) IUNIT, the FORTRAN unit.
!
!    Input, integer ( kind = 4 ) NELEM, the number of elements.  If you are 
!    using 3 node triangles, then NELEM should be this number.  If you are 
!    using 6 node triangles, then NELEM should be 4 times that number, since 
!    each 6 node triangle you were using will be reported to TECPLOT as 
!    4 triangles of 3 nodes.
!
!    Input, integer ( kind = 4 ) NP, the number of nodes.
!
...
!    Input, integer ( kind = 4 ) IUNIT, the FORTRAN unit.
!
!    Input, integer ( kind = 4 ) NTRI, the number of triangles.
!
!    Input, integer ( kind = 4 ) NODE(3,NTRI), gives, for each triangle, the 
!    indices of the three nodes that make it up.
!
  implicit none
...
!    Input, integer ( kind = 4 ) NTRI, the number of triangles.
!
!    Input, integer ( kind = 4 ) NODE(6,NTRI), gives, for each triangle, the 
!    indices of the six nodes that make it up.  Consult the diagram to see 
!    the order that is assumed.
!
  implicit none
...
!    Input, integer ( kind = 4 ) IUNIT, the FORTRAN unit.
!
!    Input, integer ( kind = 4 ) NX, the number of grid points 
!    in the X direction.
!
!    Input, integer ( kind = 4 ) NY, the number of grid points 
!    in the Y direction.
!
...
!    Input, integer ( kind = 4 ) IUNIT, the FORTRAN unit.
!
!    Input, integer ( kind = 4 ) NX, the number of grid points in 
!    the X direction.
!
!    Input, integer ( kind = 4 ) NY, the number of grid points in 
!    the Y direction.
!
...
!    Input, integer ( kind = 4 ) IUNIT, the FORTRAN unit.
!
!    Input, integer ( kind = 4 ) NX, the number of grid points in the 
!    X direction.
!
!    Input, integer ( kind = 4 ) NY, the number of grid points in the
!    Y direction.
!
!    Input, real ( kind = 8 ) X(NX), the X coordinates of the grid lines.
!
...
!    Input, integer ( kind = 4 ) IUNIT, the FORTRAN unit.
!
!    Input, integer ( kind = 4 ) NR, the number of grid points in the 
!    R direction (from the center out).
!
!    Input, integer ( kind = 4 ) NZ, the number of grid points in the 
!    Z direction (up).
!
!    Input, integer ( kind = 4 ) NT, the number of grid points to create in the
