...
!*****************************************************************************80
!
!! MAIN is the main program for HAMMERSLEY_ADVANCED_PRB.
!
!  Discussion:
!
!    HAMMERSLEY_ADVANCED_PRB tests the HAMMERSLEY_ADVANCED library.
!
!  Licensing:
!
...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'HAMMERSLEY_ADVANCED_PRB'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the HAMMERSLEY_ADVANCED library.'
