...
!
  ...
  write ( *, '(a)' ) &
    '  Gnuplot command data written to the file "string_commands.txt".'
!
!  Terminate.
!
  write ( *, '(a)' ) ''
...
!
!    Output, real ( kind = 8 ) F, the value of the solution at time 0 
!    and location X.
!
  implicit none
...
!    Input, real ( kind = 8 ) X, the location.
!
!    Output, real ( kind = 8 ) G, the value of the time derivative of the 
!    solution at time 0 and location X.
!
  implicit none
