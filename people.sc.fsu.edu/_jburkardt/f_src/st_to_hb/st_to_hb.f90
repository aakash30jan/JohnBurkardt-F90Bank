...
!
!    Input, integer ( kind = 4 ) NROW, the assumed number of rows in 
!    the matrix.
!
!    Input, integer ( kind = 4 ) NCOL, the assumed number of columns 
!    in the matrix.
!
!    Input, integer ( kind = 4 ) NNZERO, the assumed number of nonzeros 
!    in the matrix.
!
!    Output, integer ( kind = 4 ) ROW(NNZERO), COL(NNZERO), the 0-based row 
...
!    Input, character ( len = * ) INPUT_FILENAME, the name of the ST file.
!
!    Output, integer ( kind = 4 ) NROW, the assumed number of rows in 
!    the matrix.
!
!    Output, integer ( kind = 4 ) NCOL, the assumed number of columns 
!    in the matrix.
!
