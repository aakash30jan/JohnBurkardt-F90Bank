...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'SPHERE_LLT_GRID_TEST'
  write ( *, '(a)' ) '  MATLAB version'
  write ( *, '(a)' ) '  Test the SPHERE_LLT_GRID library.'

  call sphere_llt_grid_point_count_test ( )
  call sphere_llt_grid_points_test ( )
  call sphere_llt_grid_line_count_test ( )
  call sphere_llt_grid_lines_test ( )
  call sphere_llt_grid_display_test ( )
!
!  Terminate.
!
  write ( *, '(a)' ) ''
...
subroutine sphere_llt_grid_point_count_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'SPHERE_LLT_GRID_POINT_COUNT_TEST'
  write ( *, '(a)' ) '  SPHERE_LLT_GRID_POINT_COUNT counts the points used for a'
  write ( *, '(a)' ) '  grid based on triangles defined by latitude and longitude'
  ...
  do lat_num = 1, 17, 2
    ...
    do long_log = 1, 4
      long_num = long_num * 2
      call sphere_llt_grid_point_count ( lat_num, long_num, point_num )
...
subroutine sphere_llt_grid_points_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'SPHERE_LLT_GRID_POINTS_TEST'
  write ( *, '(a)' ) '  SPHERE_LLT_POINTS produces latitude/longitude'
  ...
  call sphere_llt_grid_point_count ( lat_num, long_num, node_num )
  ...
  call sphere_llt_grid_points ( r, pc, lat_num, long_num, node_num, node_xyz )
...
subroutine sphere_llt_grid_line_count_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'SPHERE_LLT_GRID_LINE_COUNT_TEST'
  write ( *, '(a)' ) '  SPHERE_LLT_GRID_LINE_COUNT counts the lines used for a'
  write ( *, '(a)' ) '  grid based on triangles defined by latitude and longitude'
  write ( *, '(a)' ) '  lines on a sphere in 3D.'
  write ( *, '(a)' ) ''
  ...
  do lat_num = 1, 17, 2
    ...
    do long_log = 1, 4
      long_num = long_num * 2
      call sphere_llt_grid_line_count ( lat_num, long_num, line_num )
...
subroutine sphere_llt_grid_lines_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'SPHERE_LLT_GRID_LINES_TEST'
  write ( *, '(a)' ) '  SPHERE_LLT_GRID_LINES computes grid lines'
  ...
  call sphere_llt_grid_lines ( lat_num, long_num, line_num, line_data )
...
subroutine sphere_llt_grid_display_test ( )
...
!
  ...
  write ( *, '(a)' ) ''
  write ( *, '(a)' ) 'SPHERE_LLT_GRID_DISPLAY_TEST'
  write ( *, '(a)' ) '  SPHERE_LLT_GRID_DISPLAY displays an LLT grid on a sphere.'
  write ( *, '(a)' ) ''
  write ( *, '(a,i4)' ) '  Number of latitudes is  ', lat_num
  write ( *, '(a,i4)' ) '  Number of longitudes is ', long_num
!
...
!
  ...
  call sphere_llt_grid_display ( node_num, node_xyz, line_num, line_data, &
    prefix )
