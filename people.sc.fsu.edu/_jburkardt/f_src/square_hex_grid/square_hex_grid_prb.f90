...
!
  ...
  call timestamp ( )
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'SQUARE_HEX_GRID_PRB'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the SQUARE_HEX_GRID library.'
!
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) '  R8MAT_WRITE writes the data to a file.'
  ...
  do test = 1, test_num
    ...
    write ( file_name, '(a,i3,a,i3,a,i6,a)' ) &
      'hex_grid_01_', nodes_per_layer, '_', layers, '_', n, '_data.txt'
    ...
    call r8mat_write ( file_name, 2, n, p )
...
!
  ...
  do test = 1, test_num
    ...
    write ( file_name, '(a,i3,a,i3,a,i6,a)' ) &
      'hex_grid_', nodes_per_layer, '_', layers, '_', n, '_data.txt'
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST13'
  write ( *, '(a)' ) '  HEX_GRID_PLOT creates files for GNUPLOT graphics.'
  ...
  do test = 1, test_num
    ...
    write ( header, '(a,i3,a,i3,a,i6)' ) &
      'hex_grid_', nodes_per_layer, '_', layers, '_', n

    call s_blank_delete ( header )

    call hex_grid_plot ( 2, n, box, p, header )
