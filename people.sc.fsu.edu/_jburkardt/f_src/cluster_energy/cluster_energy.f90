...
!    energy clustering.
!
!    Input, integer ( kind = 4 ) IT_LO, IT_HI, the least and most number of 
!    energy iterations.
!
  implicit none
...
!    clusters to consider.
!
!    Output, integer ( kind = 4 ) IT_LO, IT_HI, the least and most number of
!    energy iterations.
!
  implicit none
...
!
!    Input, real ( kind = 8 ) CENTER(DIM_NUM,C_NUM), the coordinates of the
!    center points.
!
