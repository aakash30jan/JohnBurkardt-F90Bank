...
!*****************************************************************************80
!
!! COST_TEST tests the COST transform routines.
!
!  Licensing:
!
...
!*****************************************************************************80
!
!! TEST01 tests COST1B, COST1F, COST1I.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  integer ( kind = 4 ), parameter :: lenwrk = n - 1
  integer ( kind = 4 ), parameter :: lensav = 8204
...
!*****************************************************************************80
!
!! TEST02 tests DCOST1B, DCOST1F, DCOST1I.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST02'
  write ( *, '(a)' ) '  For double precision fast cosine transforms, 1D,'
  write ( *, '(a)' ) '  DCOST1I initializes the transforms,'
  write ( *, '(a)' ) '  DCOST1F does a forward transforms;'
  write ( *, '(a)' ) '  DCOST1B does a backward transforms.'
  write ( *, '(a)' ) ' '
  write ( *, '(a,i4)' ) '  The number of data items is N = ', n
!
!  Set the data values.
...
!  Allocate and initialize the WSAVE array.
!
  call dcost1i ( n, wsave, lensav, ier )
!
!  Compute the FFT coefficients.
!
  inc = 1
  ...
  call dcost1f ( n, inc, r, lenr, wsave, lensav, work, lenwrk, ier )
...
!  original data.
!
  call dcost1b ( n, inc, r, lenr, wsave, lensav, work, lenwrk, ier )
