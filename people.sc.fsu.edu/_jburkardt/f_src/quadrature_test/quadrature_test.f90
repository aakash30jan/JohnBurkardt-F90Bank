...
!  Discussion:
!
!    The user supplies a quadrature rule for an M-dimensional rectangle,
!    and the program tries it on a set of test integrands.
!
!  Licensing:
!
...
!
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'QUADRATURE_TEST: User input:'
