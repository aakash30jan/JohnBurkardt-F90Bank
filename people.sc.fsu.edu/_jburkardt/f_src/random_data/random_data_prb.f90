...
!
  ...
  call test20 ( )
  call test205 ( )
  call uniform_in_triangle_map1_test ( )
  call test22 ( )
  call test23 ( )
  call test235 ( )
  call test24 ( )
...
subroutine uniform_in_triangle_map1_test ( )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'UNIFORM_IN_TRIANGLE_MAP1_TEST'
...
!
  ...
  character ( len = 80 ) :: output_filename = 'uniform_on_cube01.txt'
  integer ( kind = 4 ) :: seed = 123456789
  real ( kind = 8 ) x(m,n)

  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TEST235'
  write ( *, '(a)' ) '  UNIFORM_ON_CUBE01 samples N uniform points on'
