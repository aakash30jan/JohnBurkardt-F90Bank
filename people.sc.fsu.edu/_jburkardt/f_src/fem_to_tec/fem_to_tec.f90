...
!
!    Input, integer ( kind = 4 ) NODE_DATA_NUM, the number of data items per
!    node.
!
...
!    from the "shape" of the data in the node file.
!
...
!    in the file.  If the file could not be opened, then LINE_NUM is 
!    returned as -1.
!
  implicit none
