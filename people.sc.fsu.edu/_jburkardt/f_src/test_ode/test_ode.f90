...
subroutine p00_jac ( test, neqn, t, y, jac )
...
!
!    Output, real ( kind = 8 ) JAC(NEQN,NEQN), the jacobian matrix.
!
  implicit none

  integer ( kind = 4 ) neqn

  real ( kind = 8 ) jac(neqn,neqn)
  integer ( kind = 4 ) test
  real ( kind = 8 ) t
  real ( kind = 8 ) y(neqn)

  if ( test == 1 ) then
    call p01_jac ( neqn, t, y, jac )
  else if ( test == 2 ) then
    call p02_jac ( neqn, t, y, jac )
  else if ( test == 3 ) then
    call p03_jac ( neqn, t, y, jac )
  else if ( test == 4 ) then
    call p04_jac ( neqn, t, y, jac )
  else if ( test == 5 ) then
    call p05_jac ( neqn, t, y, jac )
  else if ( test == 6 ) then
    call p06_jac ( neqn, t, y, jac )
  else if ( test == 7 ) then
    call p07_jac ( neqn, t, y, jac )
  else if ( test == 8 ) then
    call p08_jac ( neqn, t, y, jac )
  else if ( test == 9 ) then
    call p09_jac ( neqn, t, y, jac )
  else if ( test == 10 ) then
    call p10_jac ( neqn, t, y, jac )
  else if ( test == 11 ) then
    call p11_jac ( neqn, t, y, jac )
  else if ( test == 12 ) then
    call p12_jac ( neqn, t, y, jac )
  else if ( test == 13 ) then
    call p13_jac ( neqn, t, y, jac )
  else if ( test == 14 ) then
    call p14_jac ( neqn, t, y, jac )
  else if ( test == 15 ) then
    call p15_jac ( neqn, t, y, jac )
  else if ( test == 16 ) then
    call p16_jac ( neqn, t, y, jac )
  else if ( test == 17 ) then
    call p17_jac ( neqn, t, y, jac )
  else if ( test == 18 ) then
    call p18_jac ( neqn, t, y, jac )
  else if ( test == 19 ) then
    call p19_jac ( neqn, t, y, jac )
  else if ( test == 20 ) then
    call p20_jac ( neqn, t, y, jac )
  else if ( test == 21 ) then
    call p21_jac ( neqn, t, y, jac )
  else if ( test == 22 ) then
    call p22_jac ( neqn, t, y, jac )
  else if ( test == 23 ) then
    call p23_jac ( neqn, t, y, jac )
  else if ( test == 24 ) then
    call p24_jac ( neqn, t, y, jac )
  else if ( test == 25 ) then
    call p25_jac ( neqn, t, y, jac )
  else if ( test == 26 ) then
    call p26_jac ( neqn, t, y, jac )
  else if ( test == 27 ) then
    call p27_jac ( neqn, t, y, jac )
  else if ( test == 28 ) then
    call p28_jac ( neqn, t, y, jac )
  else if ( test == 29 ) then
    call p29_jac ( neqn, t, y, jac )
  else if ( test == 30 ) then
    call p30_jac ( neqn, t, y, jac )
  else if ( test == 31 ) then
    call p31_jac ( neqn, t, y, jac )
  else if ( test == 32 ) then
    call p32_jac ( neqn, t, y, jac )
  else if ( test == 33 ) then
    call p33_jac ( neqn, t, y, jac )
  else if ( test == 34 ) then
    call p34_jac ( neqn, t, y, jac )
  else if ( test == 35 ) then
    call p35_jac ( neqn, t, y, jac )
  else if ( test == 36 ) then
    call p36_jac ( neqn, t, y, jac )
  else if ( test == 37 ) then
    call p37_jac ( neqn, t, y, jac )
  else if ( test == 38 ) then
    call p38_jac ( neqn, t, y, jac )
  else if ( test == 39 ) then
    call p39_jac ( neqn, t, y, jac )
  else if ( test == 40 ) then
    call p40_jac ( neqn, t, y, jac )
  else
    write ( *, '(a)' ) ' '
...
subroutine p01_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p01, Enright and Pryce #A1, exponential decay.'
...
subroutine p02_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p02, Enright and Pryce #A2'
...
subroutine p03_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p03, Enright and Pryce #A3'
...
subroutine p04_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p04, Enright and Pryce #A4'
...
subroutine p05_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p05, Enright and Pryce #A5'
...
subroutine p06_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p06, Enright and Pryce #B1'
...
subroutine p07_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p07, Enright and Pryce #B2'
...
subroutine p08_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p08, Enright and Pryce #B3'
...
subroutine p09_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p09, Enright and Pryce #B4'
...
subroutine p10_jac ( neqn, t, y, jac )
...
!
  ...
  jac(2,2) =  0.00D+00
  jac(2,3) = -y(1)
  jac(3,1) = -0.51D+00 * y(2)
  jac(3,2) = -0.51D+00 * y(1)
  jac(3,3) =  0.00D+00
...
!
  ...
  title = 'Problem p10, Enright and Pryce #B5'
...
subroutine p11_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p11, Enright and Pryce #C1'
...
subroutine p12_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p12, Enright and Pryce #C2'
...
subroutine p13_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p13, Enright and Pryce #C3'
...
subroutine p14_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p14, Enright and Pryce #C4'
...
subroutine p15_jac ( neqn, t, y, jac )
...
!  Discussion:
!
!    The jacobian information has not yet been set up for this problem.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license.
...
!
  ...
  title = 'Problem p15, Enright and Pryce #C5'
...
subroutine p16_jac ( neqn, t, y, jac )
...
!
  ...
  jac(1,3) = 1.0D+00
  jac(2,4) = 1.0D+00
  jac(3,1) = ( 2.0D+00 * y(1)**2 - y(2)**2 ) / d
  jac(3,2) = 3.0D+00 * y(1) * y(2) / d
  jac(4,1) = 3.0D+00 * y(1) * y(2) / d
  jac(4,2) = ( - y(1)**2 + 2.0D+00 * y(2)**2 ) / d
...
!
  ...
  title = 'Problem p16, Enright and Pryce #D1'
...
subroutine p17_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p17, Enright and Pryce #D2'
...
subroutine p18_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p18, Enright and Pryce #D3'
...
subroutine p19_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p19, Enright and Pryce #D4'
...
subroutine p20_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p20, Enright and Pryce #D5'
...
subroutine p21_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p21, Enright and Pryce #E1'
...
subroutine p22_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p22, Enright and Pryce #E2'
...
subroutine p23_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p23, Enright and Pryce #E3'
...
subroutine p24_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p24, Enright and Pryce #E4'
...
subroutine p25_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p25, Enright and Pryce #E5'
...
subroutine p26_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p26, Enright and Pryce #F1'
...
subroutine p27_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p27, Enright and Pryce #F2'
...
subroutine p28_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p28, Enright and Pryce #F3'
...
subroutine p29_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p29, Enright and Pryce #F4'
...
subroutine p30_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p30, Enright and Pryce #F5'
...
subroutine p31_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p31, Lotka-Volterra Predator-Prey Equations.'
...
subroutine p32_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p32, The Lorenz System'
...
subroutine p33_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p33, The Van der Pol equation'
...
subroutine p34_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p34, The Linearized Damped Pendulum'
...
subroutine p35_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p35, The Nonlinear Damped Pendulum'
...
subroutine p36_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p36, Duffing''s Equation'
...
subroutine p37_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p37, Duffing''s Equation with Damping and Forcing'
...
subroutine p38_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p38, Shampine''s Ball of Flame'
...
subroutine p39_jac ( neqn, t, y, jac )
...
!
  ...
  title = 'Problem p39, Polking''s first order ODE'
...
!
  ...
  call p40_param ( 'GET', 'E', e )

  yp(1) = y(1) * ( y(1) - t ) / e

  return
end
subroutine p40_jac ( neqn, t, y, jac )
...
!
  ...
  y_stop(1) = - 2.0D+00 * sqrt ( e ) &
    * exp ( ( 1.0D+00 - t_stop * t_stop ) / ( 2.0D+00 * e ) ) / &
    ( &
      2 * sqrt ( e ) + &
      ( &
        error_f ( 1.0D+00 / sqrt ( 2.0D+00 * e ) )  + &
        error_f ( t_stop  / sqrt ( 2.0D+00 + e ) ) &
      ) &
      * exp ( 0.5D+00 / e ) * sqrt ( 2.0D+00 * pi ) &
    )
...
!
  ...
  title = 'Problem p40, the Knee problem'
