...
!
!    * sample_prefix_nodes.txt,     node coordinates where samples were taken;
...
!
  ...
  call i4mat_header_read ( fem_element_filename, fem_element_order, &
    fem_element_num )
  ...
  call i4mat_data_read ( fem_element_filename, fem_element_order, &
...
!
  ...
  call fem3d_transfer ( sample_node_num, sample_element_order, &
    ...
    sample_node_xyz, sample_element_node, sample_element_neighbor, &
    sample_value, fem_node_num, fem_element_order, &
...
!    SAMPLE_ELEMENT_NODE(SAMPLE_ELEMENT_ORDER,SAMPLE_ELEMENT_NUM),
...
!
!    Input, integer ( kind = 4 ) 
!    FEM_ELEMENT_NODE(FEM_ELEMENT_ORDER,FEM_ELEMENT_NUM),
!    the nodes that make up each element.
!
...
!
  ...
  do element = 1, fem_element_num
    ...
    tet_quad(1:3,1:quad_num) = &
      matmul ( tet_xyz(1:3,1:4), ref_quad(1:4,1:quad_num) )
!
...
!
!    Input, real ( kind = 8 ) SAMPLE_NODE_XYZ(3,SAMPLE_NODE_NUM), 
!    the sample nodes.
!
...
!
    ...
    t_xyz(1:3,1:fem_element_order) = &
      fem_node_xyz(1:3,t_node(1:fem_element_order))
