...
!*****************************************************************************80
!
!! MAIN is the main program for TRIANGLE_LYNESS_RULE_PRB.
!
!  Discussion:
!
!    TRIANGLE_LYNESS_RULE_PRB tests the TRIANGLE_LYNESS_RULE library.
!
!  Licensing:
!
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'TRIANGLE_LYNESS_RULE_PRB:'
  write ( *, '(a)' ) '  FORTRAN90 version'
  write ( *, '(a)' ) '  Test the TRIANGLE_LYNESS_RULE library.'
