...
!
  ...
  write ( *, '(a,g14.6,2x,g14.6)' ) &
    '  ALPHA_MIN  : minimum over all triangles = ', &
    alpha_min, alpha_min * 60.0D+00
  write ( *, '(a,g14.6,2x,g14.6)' ) &
    '  ALPHA_AVE  : average over all triangles = ', &
    alpha_ave, alpha_ave * 60.0D+00
  write ( *, '(a,g14.6,2x,g14.6)' ) &
    '  ALPHA_AREA : average weighted by area =  ', &
    alpha_area, alpha_area * 60.0D+00
